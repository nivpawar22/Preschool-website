...
<body>
  ...
  <script src="/static/data.js?v=26"></script>
  <script src="/static/app.js?v=26"></script>
  <script src="/static/admin.js?v=26"></script>
  <script src="/static/management.js?v=26"></script>
  <script src="/static/parent.js?v=26"></script>
  <script src="/static/admissions.js?v=26"></script>
  <script src="/static/accounting.js?v=26"></script>
  <script src="/static/teacher.js?v=26"></script>
  <script src="/static/teachers.js?v=26"></script>
  <script>
  (function(){
