...
function printAdmForm() {
  ...
  win.document.write('<!DOCTYPE html><html><head><meta charset="UTF-8"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css"><title>Admission Form</title><style>' +
    ...
    '.sigs{display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;margin:14px 14px 0}.sl{border-top:2px solid #0F2050;text-align:center;font-size:11px;font-weight:bold;color:#0F2050;height:56px;display:flex;align-items:flex-end;justify-content:center;padding-bottom:4px}' +
