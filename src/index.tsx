...
<body>
  <div id="app"></div>
  <script src="/static/data.js?v=10"></script>
  <script src="/static/app.js?v=10"></script>
  <script src="/static/admin.js?v=10"></script>
  <script src="/static/management.js?v=10"></script>
  <script src="/static/parent.js?v=10"></script>
  <script src="/static/admissions.js?v=10"></script>
</body>
</html>`)
})
