...
// ============================================================
// Shared School Print/PDF Header
// One canonical header (logo, name, gold subtitle, contact bar,
// address) used by every printed document / PDF export in the app,
// so they all render with the same design and fonts.
// ============================================================
...
function renderLayout(activeTab, contentHtml, pageTitle = '', breadcrumb = '') {
  ...
  if (user.role === 'admission') {
    ...
    navItems = [
      ...
      { id: 'parent-health', icon: 'fa-heartbeat', label: 'Health' },
      { id: 'parent-contacts', icon: 'fa-phone-alt', label: 'Contacts' },
      { id: 'parent-ptm', icon: 'fa-handshake', label: 'PTM' },
      { id: 'parent-grievance', icon: 'fa-comment-dots', label: 'Grievance' },
      { id: 'parent-conduct', icon: 'fa-star', label: 'Conduct' },
      { id: 'parent-documents', icon: 'fa-file-download', label: 'Documents', divider: true, dividerLabel: 'Account' },
      { id: 'parent-notifications', icon: 'fa-bell', label: 'Notifications' },
      { id: 'parent-profile', icon: 'fa-user-circle', label: 'My Profile' },
